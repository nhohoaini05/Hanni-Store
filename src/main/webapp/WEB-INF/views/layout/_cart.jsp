			...
			<ul class="mini-products-list">
				<li ng-repeat="i in cart.items" class="item"><a
					...
					<div class="product-details">
						...
						<div class="wrapQtyBtn">
							<div class="qtyField">
								<span class="label">SL: </span> <a ng-click="cart.minus(i.id)"
									ng-if="i.qty > 1" class="qtyBtn minus" href=""><i
									...
									class="product-form__input qty" style="width: 50px" min="1">
						...
						<div class="priceRow">
							<div class="product-price list-group list-group-flush">
								<span class="money list-group-item">{{ cart.priceItem(i.id) | number:0 }}</p></span>
							</div>
						</div>
					</div>		
			</li>
