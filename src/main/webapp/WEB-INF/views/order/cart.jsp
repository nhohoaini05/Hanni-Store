					...
					<div class="col-12 col-sm-12 col-md-8 col-lg-8 main-col">
						<form action="#" method="post" class="cart style2">
								...
								<tbody>
									<tr ng-repeat="i in cart.items"
										...
										<td class="cart__price-wrapper cart-flex-item"><span
											class="money">đ{{i.price | number: 0}}</span></td>
										<td class="cart__price-wrapper cart-flex-item"><span
											class="money">{{ cart.priceItem(i.id) | number:0 }} - {{i.discount | number: 0}}%</span></td>
										...
										<td class="text-right small--hide cart-price">
											<div>
												<span class="money">đ{{cart.priceItem(i.id) | number: 0}}</span>
											</div>
										</td>
							...
							<div class="currencymsg">Miễn phí vận chuyển đơn hàng từ
								200K nội thành TP ĐÀ NẴNG, ngoại thành chịu phí ship sẽ được cập nhật
						...
						<div class="solid-border">
							<div class="row">
								<span class="col-12 col-sm-6 cart__subtotal-title"><strong>Tổng
									...
									class="money">{{cart.amount | number: 0}} VND</span></span>
							</div>
